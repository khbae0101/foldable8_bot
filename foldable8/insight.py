...
CLOSING = {
    ...
    "20260728": ("🔥 출시까지 D-7 · 잔여 영업일 5일\n"
                 "어느새 반환점입니다. 매일 같은 자리에서 최선을 다한다는 건 결코 쉬운 일이 아니에요. "
                 "그 꾸준함이 결국 우리를 결승선으로 데려갑니다. 오늘도 정말 수고하셨습니다."),
    ...
    "20260731": ("🌈 출시까지 D-4 · 잔여 영업일 2일\n"
                 "7월의 마지막 날입니다. 한 달을 쉼 없이 달려온 여러분, 그 자체로 이미 자랑스럽습니다. "
                 "마지막 주말을 앞두고, 우리가 가진 열정을 조금만 더 모아봅시다."),
    "20260801": ("❤️‍🔥 출시까지 D-3 · 잔여 영업일 1일\n"
                 "마지막 토요일, 우리에게 가장 소중한 하루입니다. 지난 한 달의 모든 노력이 "
                 "오늘 이 자리에 담겨 있어요. 후회 없이, 뜨겁게. 여러분의 오늘을 진심으로 응원합니다."),
