...
CLOSING = {
    "20260725": ("🌙 폴더블8 출시까지 D-10 · 잔여 영업일 7일\n"
                 "언팩 후 첫 주말, 하루 종일 고객을 맞느라 애쓰신 하루였습니다. 오늘 여러분이 건넨 "
                 "진심 어린 한마디가 예약 한 건으로 돌아왔어요. 오늘은 푹 쉬시고, 월요일에 또 웃으며 만나요."),
    "20260727": ("☀️ 출시까지 D-8 · 잔여 영업일 6일\n"
                 "새로운 한 주가 밝았습니다. 지난주의 땀이 헛되지 않도록, 오늘도 한 걸음씩. "
                 "무거운 월요일을 열어주신 여러분 덕에 우리 지사가 오늘도 움직입니다. 고맙습니다."),
    "20260728": ("🔥 출시까지 D-7 · 잔여 영업일 5일\n"
                 "공식 사전예약 첫날, 눈코 뜰 새 없이 바쁜 하루였죠. 하루가 유난히 길게 "
                 "느껴지셨을 거예요. 그래도 오늘의 한 건 한 건, 모두 여러분이 만들어낸 것입니다. "
                 "정말 고생 많으셨습니다."),
    "20260729": ("💪 출시까지 D-6 · 잔여 영업일 4일\n"
                 "한 주의 한가운데, 조금은 지치는 날입니다. 그래도 여러분이 오늘 채운 한 칸이 "
                 "내일의 우리를 앞으로 밀어줍니다. 잠깐 숨 고르고, 다시 함께 가요."),
    "20260730": ("🌟 출시까지 D-5 · 잔여 영업일 3일\n"
                 "이제 정말 며칠 남지 않았습니다. 힘든 거, 압니다. 그래도 옆자리 동료가 있고, "
                 "뒤에서 응원하는 우리가 있어 여기까지 왔어요. 혼자가 아니니까, 조금만 더 힘내요."),
    "20260731": ("🌈 출시까지 D-4 · 잔여 영업일 2일\n"
                 "7월의 마지막 날이었습니다. 한 달을 쉼 없이 달려온 여러분, 그 자체로 이미 자랑스럽습니다. "
                 "마지막 주말을 앞두고, 우리가 가진 열정을 조금만 더 모아봅시다."),
    "20260801": ("❤️‍🔥 출시까지 D-3 · 잔여 영업일 1일\n"
                 "마지막 토요일, 우리에게 가장 소중한 하루였습니다. 지난 한 달의 모든 노력이 "
                 "오늘 이 자리에 담겨 있어요. 후회 없이, 뜨겁게. 여러분의 내일을 진심으로 응원합니다."),
    "20260803": ("🎉 대장정의 마지막 날입니다 (내일, 드디어 폴더블8 출시!)\n"
                 "한 달간 정말 고생 많으셨습니다. 이른 아침부터 늦은 저녁까지, 여러분의 하루하루가 "
                 "모여 오늘의 강동소매를 만들었습니다. 마지막 한 건까지, 우리답게. "
                 "여러분 모두가 강동소매의 자부심입니다. 🎊"),
}
