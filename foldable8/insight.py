...
CLOSING = {
    # 마감(20:15) 발송 멘트 — "오늘 수고 + 내일 준비" 톤
    # ── 9/5(토) ~ 9/11(목) : 지난 날짜 (재사용 대비) ──
    "20260905": "🚀 첫날 마감, 고생 많으셨습니다\n"
                "13일 여정의 첫 단추를 잘 끼웠습니다. "
                "오늘 만난 고객 리스트 정리해두시고, 내일 이어가요.",
    "20260908": "💪 한 주의 시작, 잘 버텨주셨습니다\n"
                "지금 확보한 대기 고객이 결국 실적이 됩니다. "
                "내일도 컨택 한 건씩 쌓아가 봅시다.",
    "20260910": "⚡ 반환점을 지났습니다, 수고하셨습니다\n"
                "쌓아둔 대기 고객 리스트, 잠들기 전 한 번만 훑어봐 주세요. "
                "내일 놓치는 분 없도록요.",
    "20260911": "🔥 목요일 마감, 고생 많으셨습니다\n"
                "이번 주말이 출시 전 마지막 주말입니다. "
                "내일 내방 고객이 많을 테니 오늘은 일찍 쉬세요.",
    # ── 9/12(토) ~ 9/17(목) : 마지막 한 주 ──
    "20260912": "🌟 출시 전 마지막 주말 첫날, 정말 고생 많으셨습니다\n"
                "토요일 내방 응대에 하루 종일 애쓰셨을 겁니다. "
                "오늘 상담만 하고 가신 분들은 월요일에 다시 연락드리기로 하고, 내일은 푹 쉬세요.",
    "20260914": "💫 마지막 주 첫날, 수고하셨습니다 — 예약 마감까지 3일\n"
                "주말 상담 고객 재컨택, 오늘 잘 진행됐을 겁니다. "
                "아직 연락 못 드린 분 있으면 내일 오전에 꼭 이어주세요.",
    "20260915": "🎯 D-2 마감, 고생 많으셨습니다\n"
                "미결정 고객이 아직 남아 있다면 내일이 마지막 기회입니다. "
                "잠들기 전 리스트 한 번만 더 확인해 주세요.",
    "20260916": "❤️‍🔥 오늘도 끝까지 붙잡아 주셔서 감사합니다\n"
                "내일이면 예약 마감입니다. "
                "마지막 하루, 후회 없이 달려봅시다.",
